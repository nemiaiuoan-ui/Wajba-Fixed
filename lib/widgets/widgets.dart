  ...
  Widget build(BuildContext context) {
    final img = CachedNetworkImage(
      ...
      errorWidget: (_, __, ___) => Container(
        ...
        child: Icon(Icons.restaurant, color: WajbaColors.grey400, size: 40),
      ),
    );
    ...
    child: AnimatedContainer(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: selected
            ? [
                BoxShadow(
                  color: WajbaColors.primary.withOpacity(0.3),
                  blurRadius: 8,
...
class OrderStatusBadge extends StatelessWidget {
  ...
  Color get _color {
    switch (status) {
      case 'delivered':
        return WajbaColors.success;
      case 'cancelled':
        return WajbaColors.error;
      case 'delivering':
        return WajbaColors.primary;
      case 'preparing':
        return WajbaColors.warning;
      default:
        return WajbaColors.grey400;
    }
  }
        ...
        children: [
          ...
          if (subtitle != null) ...[
            ...
            Text(
              ...
              style: TextStyle(fontSize: 14, color: WajbaColors.grey600),
            ),
          ],
          if (buttonLabel != null) ...[
