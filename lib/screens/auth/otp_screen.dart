          ...
          child: Column(
            ...
            children: [
              ...
              Text('Code envoyé au ${widget.phone}',
                style: TextStyle(color: WajbaColors.grey600, fontSize: 14)),
              ...
              if (auth.error.isNotEmpty) ...[
                ...
                Container(
                  ...
                  child: Text(auth.error,
                    style: TextStyle(color: WajbaColors.error, fontSize: 13)),
                ),
              ],
              ...
              Center(
                child: _canResend
                  ? TextButton.icon(
                      ...
                      icon: Icon(Icons.refresh, color: WajbaColors.primary),
