        ...
        if (quantity == 0)
          GestureDetector(
            ...
            child: Container(
              ...
              child: Icon(Icons.add, color: WajbaColors.white, size: 20),
            ),
          )
        else
          Row(
            children: [
              GestureDetector(
                ...
                child: Container(
                  ...
                  child: Icon(Icons.remove, color: WajbaColors.primary, size: 16),
                ),
              ),
              Padding(
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  child: Icon(Icons.add, color: WajbaColors.white, size: 16),
                ),
              ),
            ],
          ),
