              ...
              Positioned(top: 12, right: 12,
                child: Container(
                  ...
                  child: Text(
                    ...
                    style: TextStyle(color: WajbaColors.white,
            ...
            child: Column(
              ...
              children: [
                Row(
                  children: [
                    ...
                    Container(
                      ...
                      child: Row(children: [
                        Icon(Icons.star, size: 14, color: WajbaColors.warning),
                ...
                Text(restaurant.cuisine,
                  style: TextStyle(color: WajbaColors.grey600, fontSize: 13)),
...
class _Info extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Row(
    ...
    children: [
      ...
      Text(text, style: TextStyle(fontSize: 12, color: WajbaColors.grey600)),
    ],
  );
}
